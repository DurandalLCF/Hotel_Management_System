								...
								<div class="module-body">
									<form class="form-horizontal row-fluid" name="message" action="ModStaDB.jsp">	
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="job" id="basicinput" value="<%=emp.getJob() %>" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="date" name="hire" class="span8" value="<%=emp.getEmployeeDate() %>">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="sal" id="basicinput" value="<%=emp.getSal() %>" class="span8">
											</div>
										</div>
