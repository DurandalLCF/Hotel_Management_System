	...
	<div class="navbar navbar-fixed-top">
						...
						<div class="content">
							<div class="module">
								...
								<div class="module-body">
									<form class="form-horizontal row-fluid" name="message" action="AddStaDB.jsp">	
										<div class="control-group">
											<label class="control-label" for="basicinput">StaffNO</label>
											<div class="controls">
												<input type="text" name="sno" id="basicinput" placeholder="staffno" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="dno" id="basicinput" placeholder="deptno" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="date" name="birth" class="span8" value="1996-10-10">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="loc" id="basicinput" placeholder="location" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="job" id="basicinput" placeholder="job" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="date" name="hire" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="sal" id="basicinput" placeholder="salary" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="password" id="basicinput" placeholder="password" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
												<div class="controls">
													<button type="button" class="btn" onclick="dealt()">Add</button>
												</div>
										</div>
									</form>
								</div>
		...
		<script type="text/javascript">
			function dealt(){
				...
				sal=document.message.dno.value;
