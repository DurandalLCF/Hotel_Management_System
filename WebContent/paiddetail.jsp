...
<%
	...
	Bill book=billDao.SelectOne(billno);
								...
								<div class="module-body">
									<form class="form-horizontal row-fluid" name="message" action="pay.jsp">																
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" value="<%=book.getBillNo() %>" class="span8" readonly="readonly">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" value="<%=book.getEmployeeNo() %>" class="span8" readonly="readonly">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" value="<%=book.getRoomCost() %>" class="span8" readonly="readonly">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" value="<%=book.getOtherCost() %>" class="span8" readonly="readonly">
											</div>
										</div>
