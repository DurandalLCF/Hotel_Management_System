...
<html>
    ...
    <body>
    <%
    	String descno=request.getParameter("No");
    	DescDao descDao=new DescDao();
    	Desc desc=descDao.selectOne(descno);
    %>
    ...
    <script type="text/javascript">
    	...
    	function dealt(){
    		...
    		price=document.message.price.value;
    		gross=document.message.gross.value;
    		surplus=document.message.surplus.value;
    		
    		if(name=="" || price=="" || gross=="" || surplus==""){
						...
						<div class="content">
							<div class="module">
								<div class="module-head">
									<h3>Room Type Message</h3>
								</div>
								<div class="module-body">
									<form class="form-horizontal row-fluid" action="ModRoom.jsp" name="message">
										<div class="control-group">
											<label class="control-label" for="basicinput">Type No</label>
											<div class="controls">
												<input type="text" name="no" id="basicinput" value="<%=desc.getTypeno() %>" class="span8" readonly="readonly">
											</div>
										</div>
									
										<div class="control-group">
											<label class="control-label" for="basicinput">Type Name</label>
											<div class="controls">
												<input type="text" name="name" id="basicinput" value="<%=desc.getTypename() %>" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="price" id="basicinput" value="<%=desc.getPrice() %>" class="span8">
											</div>
										</div>
										
										<div class="control-group">
											<label class="control-label" for="basicinput">Gross</label>
											<div class="controls">
												<input type="text" name="gross" id="basicinput" value="<%=desc.getGross() %>" class="span8" readonly="readonly">
											</div>
										</div>
